  ...
  zh: {
    ...
    settings: {
      ...
      performance: {
        ...
        scrollProfilingDesc: '记录滚动时的帧耗时、掉帧率、缩略图加载等数据，用于排查滚动卡顿。记录结果输出到控制台与 scroll-perf 目录。开启后每次滚动会记录数据并写文件，会产生少量开销，建议仅在排查卡顿时开启。',
  ...
  en: {
    ...
    settings: {
      ...
      performance: {
        ...
        scrollProfilingDesc: 'Record frame timing, dropped frame rate, thumbnail loading and other data while scrolling, to help diagnose scroll jank. Reports are written to the console and the scroll-perf directory. Enabling this adds a small overhead per scroll session; it is recommended to enable only when troubleshooting.',
