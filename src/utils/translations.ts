export const translations = {
  zh: {
    ...
    settings: {
      ...
      openInImmersive: '打开图片时默认进入全屏查看',
      openInImmersiveDesc: '点击图片进入查看器时自动切换到沉浸全屏模式',
      useNativeViewer: '使用原生查看器',
      useNativeViewerDesc: '在安卓端使用原生图片查看器以获得更流畅的体验',
      exitAction: '关闭主面板时',
      exitActionAsk: '每次询问',
  ...
  en: {
    ...
    settings: {
      ...
      openInImmersive: 'Open in Fullscreen by Default',
      openInImmersiveDesc: 'Automatically enter immersive fullscreen mode when opening the viewer',
      useNativeViewer: 'Use Native Viewer',
      useNativeViewerDesc: 'Use native image viewer on Android for smoother experience',
