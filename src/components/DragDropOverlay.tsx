  ...
  return (
    ...
    >
      ...
      <div className="relative group w-[70%] max-w-6xl h-[45vh] min-h-[340px] max-h-[500px]">
        {/* 外围流光 */}
        <div className={`absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-[48px] blur transition-all duration-500 pointer-events-none ${hoveredAction === 'copy' ? 'opacity-40 scale-[1.01]' : 'opacity-0'
          } animate-pulse`}></div>

        <div
          className={`relative w-full h-full bg-white/90 dark:bg-gray-900/95 backdrop-blur-2xl rounded-[44px] shadow-2xl border-2 flex items-center overflow-hidden transition-all duration-500 pointer-events-auto px-16 ${hoveredAction === 'copy'
        ...
        >
          ...
          <div className="flex items-center justify-between w-full z-10 pointer-events-none">
            ...
            <div className="relative flex-shrink-0">
              ...
              <div className={`relative w-44 h-44 bg-gradient-to-br from-blue-500 to-blue-700 rounded-[44px] shadow-2xl flex items-center justify-center transform transition-all duration-700 ${hoveredAction === 'copy' ? 'scale-110 rotate-3 shadow-blue-500/40' : 'scale-100'
                }`}>
            ...
            <div className="flex-1 ml-20 flex justify-between items-center">
              <div className="text-left">
                <h3 className={`text-6xl font-black mb-6 bg-clip-text text-transparent transition-all duration-500 ${hoveredAction === 'copy'
          ...
          <div className={`absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-transparent via-blue-500 to-transparent transition-all duration-700 pointer-events-none ${hoveredAction === 'copy' ? 'opacity-100' : 'opacity-0'
            }`}></div>
        </div>
      </div>
    </div>
